    ...
    <header class="text-center mb-5 text-white">
      <div class="row">
        <div class="col-lg-7 mx-auto">
            <h1 class="titulo">Bootstrap pricing table</h1>
            <p class="subtitulo">Easily create a classy pricing table in Bootstrap&nbsp;4.<br> <a href="https://bootstrapious.com/snippets" class="text-reset">Bootstrap snippet by Bootstrapious</a></p>
        </div>
      </div>
    </header>
    <!-- END -->
    ...
    <div class="row text-center align-items-end">
      ...
      <div class="col-lg-4 mb-5 mb-lg-0">
        <div class="bg-white p-5 rounded-lg shadow">
          ...
          <h2 class="h1 font-weight-bold">$29.90<span class="text-small font-weight-normal ml-2">/ month</span></h2>

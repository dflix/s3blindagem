...
<div class="container py-5 backwhite">
            ...
            $(function () {
                $("#pesquisa").keyup(function () {
                    ...
                    if (pesquisa != '') {
                        ...
                        $.post("<?= CONF_URL_BASE ?>/process/buscaProd.php", dados, function (retorna) {
    ...
    <div class="row" >
                ...
                $pager = new \Source\Support\Pager("./produtos&atual=", "Primeiro", "Ultimo", "1");
                $pager->ExePager($atual, 9);

                $resultado = new \Source\Models\Read();
                $resultado->ExeRead("app_prod", "LIMIT :limit OFFSET :offset",
        ...
        <div class="col-md-3 col-sm-6" id="blog">
...
<!--                        <img class="pic-2" src="http://bestjquery.com/tutorial/product-grid/demo9/images/img-8.jpg">-->
                    ...
                    <ul class="social">
                        <li><a href="<?= CONF_URL_BASE?>/produtos/<?= $value["slug"] ?>" data-tip="Detalhes"><i class="fa fa-search"></i></a></li>
...
<!--                <ul class="rating">
                ...
                <div class="product-content">
                    <h3 class="title"><a href="<?= CONF_URL_BASE?>/produtos/<?= $value["slug"] ?>"><?= $value["produto"] ?></a></h3>
                    <div class="price"><?= $valor ?>
<!--                        <span>$10.00</span>-->
                    </div>
                    <a class="add-to-cart" href="">+ Adiconar Carrinho</a>
                </div>
            </div>
        </div>

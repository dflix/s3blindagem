<?php $v->layout("_theme", ["title" => "Confirmação de Pagamento Pedido " . $_SESSION["pedido_id"]]); ?>

<h2>Confirmação de Pagamento  <?= $_SESSION["pedido_id"] ?> </h2>
<p>Dados do Pedido  <?= $nome ?>  </p>

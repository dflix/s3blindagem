        ...
        $despesa = $despesa ;
         $carteira = $carteira ;
           $rodape = $agora->rodapegrafico() ;
            ...
            $balanco = $balanco;
            $sessao_carteira = $_SESSION['carteira'];
                    ...
                    <div class="text-center col-lg-6 col-md-6 col-12 bg-<?= $modelo; ?>" >
                        <div class="wrapper count-title d-flex text-center " style="text-align: center;">
                            ...
                            <div class="name"><strong class="text-uppercase text-left" style="color:#fff; font-size: 1.5em;">Balanço</strong>
                                ...
                                <div class="page-header"> Carteira // =><p style="font-size:1.5em; color:yellow;"> <?= $_SESSION["carteira"] ?></p>  </div>
...
<input type="radio" name="select" value="select" id="select" > <label for="select">  <p style="font-size:1.5em; color: #fff;"> Trocar Carteira</p></label>
                                ...
                                <div class="select_carteira col-md-12">
                                    <form name="carteira" action="" method="post" class="form-inline"> 
                                    <select name="carteira" class="form-control">
                                        ...
                                        ?>
                                        <option value="<?=$value['wallet'] ?>"> <?=$value['wallet'] ?> </option>
        ...
        <div class="col-lg-8">
            <h2 class="display h4 bg-front text-white">Movimentação Financeira</h2>
        ...
        <div class="col-lg-4">
                          <div class="card project-progress">
                            <h2 class="display h4 bg-front text-white">Projeção de Saidas</h2>
 ...
 <?php 
                                    ...
                                    <li class="d-flex justify-content-between"> 
                                        <div class="left-col d-flex">
                                            ...
                                            <div class="title"><strong style="font-size:1em; color:#000;"><?= $value["descricao"] ?></strong>
                                                <p style="font-size:0.9em; color:#000;">R$ <?= number_format($value["valor"] / 100, 2, ",", ".")  ?> </p>
                                        ...
                                        <div class="right-col text-right">
                                            <div class="update-date"><em><p style="font-size:0.9em; "></br><?php                                                                
                ...
                <div class="col-lg-6 col-md-6">
                    ...
                    <div id="daily-feeds" class="card updates daily-feeds">
                        <div id="feeds-header" class="card-header d-flex justify-content-between align-items-center bg-danger">
                            <h2 class="h5 btn-danger"><a style="text-decoration:none; color:#fff;" data-toggle="collapse" data-parent="#daily-feeds" href="#feeds-box" aria-expanded="true" aria-controls="feeds-box">Contas a Pagar </a></h2>
                        ...
                        <div id="feeds-box" role="tabpanel" class="collapse show">
                            <div class="feed-box">
                                <ul class="feed-elements list-unstyled">
                                    ...
                                    <li class="d-flex justify-content-between"> 
                                        <div class="left-col d-flex">
                                            <div class="icon"><i class="fa fa-minus-square" style="font-size:1em; color:red;"></i></div>
                                            <div class="title"><strong style="font-size:1em; color:#000;"><?= $value["descricao"] ?></strong>
                                                <p style="font-size:0.9em; color:#000;">R$ <?= number_format($value["valor"] / 100, 2, ",", ".")  ?> </p>
                                                            <form action="" method="post">
                                             <input type="hidden" name="id" value="<?= $value["id"]?>" />

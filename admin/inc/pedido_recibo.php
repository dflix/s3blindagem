    ...
    <div class="row col-md-12"> 
        ...
        <form method="post" action=""> 
            <div class="col-md-12"> 
                ...
                <input type="text" class="form-control" name="de" value="<?= $cliente->getResult()[0]["nome"] ?>"  />
            </div>  
            <div class="col-md-12"> 
                <label>Valor </label>
                <input type="text" id="valor" class="form-control" name="valor" value="<?= number_format($totalpedido / 100, 2, ".", "."); ?>" />
            </div>  
            <div class="col-md-12"> 
                <label>Referente a </label>
                <input type="text" class="form-control" name="descricao" value="<?= $viewcar["modelo"] ?> <?= $viewcar["placa"] ?> " />
            </div>  
            <div class="col-md-12"> 
                <label>Forma de Pagamento </label>
                <input type="radio"  name="forma_pagamento" value="cartão crédito" /> Cartão Crédito
                <input type="radio"  name="forma_pagamento" value="cartão debito" /> Cartão Débito
                <input type="radio"  name="forma_pagamento" value="dinheiro" /> Dinheiro
            </div> 
            <div class="col-md-12"> 
                <label>Status de Pagamento </label>
                <input type="radio"  name="pagamento" value="pago" /> Pago
                <input type="radio"  name="pagamento" value="avencer" /> A Vencer
              
            </div> 
            
            <div class="col-md-12">
                <label> Data de Pagamento</label>
                 <input type="date" id="date" name="data_pagamento"  class="form-control input-datepicker" />
            </div>  
            <div class="col-md-12"> 
                
                <input type="submit" class="btn btn-success" value="Cadastrar Recibo" />
            </div>  

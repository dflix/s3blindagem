   ...
   //PRIVATE
    ...
    private function getSyntax() {
        ...
        for($iPag = $this->Page - $MaxLinks; $iPag <= $this->Page -1; $iPag++):
            if($iPag >=1):
         $this->Paginator .= "<li class=\"page-item\"><a class=\"page-link\" title=\"Pagina{$iPag}\" href=\"{$this->Link}{$iPag}\"> {$iPag} </a> </li>";   
        endif;
         endfor;
         
         $this->Paginator .="<li class=\"page-link\"> <span class=\"active\"> {$this->Page} </span></li>";
         
         for($dPag = $this->Page + 1 ; $dPag <= $this->Page + $MaxLinks; $dPag++):
         if($dPag <= $Paginas):
         $this->Paginator .= "<li class=\"page-item\"><a class=\"page-link\" title=\"Pagina{$dPag}\" href=\"{$this->Link}{$dPag}\"> {$dPag} </a> </li>";   
        endif;
         endfor;
